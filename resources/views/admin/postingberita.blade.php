...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/postingberita.css') }}" />
</head>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            ...
            <!-- Form Posting Berita -->
            <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="form-posting">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="dropzone-box" onclick="document.getElementById('imageInput').click()">
                        <input type="file" name="imageberita" id="imageInput" accept="image/*" required hidden onchange="previewImage(this)">
                        <div class="dropzone-content" id="dropzoneContent">
                            <ion-icon name="cloud-upload-outline" class="upload-icon"></ion-icon>
                            <p class="dropzone-title">Masukkan foto berita disini</p>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="judulberita" id="judul" maxlength="255" placeholder="Masukkan judul berita disini" required oninput="updateCharCount(this)" value="{{ old('judul') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsiberita" id="deskripsi" rows="5" placeholder="Masukkan deskripsi berita disini" required>{{ old('deskripsi') }}</textarea>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.berita') }}" class="btn-cancel">Batal</a>
                </div>
            </form>
        </div>
    </div>
